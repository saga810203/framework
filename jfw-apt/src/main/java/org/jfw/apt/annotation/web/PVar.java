...
import org.jfw.apt.model.web.handlers.buildparam.PVarHandler;

@Target(ElementType.PARAMETER)
@Retention(RetentionPolicy.SOURCE)
public @interface PVar {
	boolean encoding() default false;
	String pathAttribute() default "org.jfw.web.reqMacthUri_DYN";
	Class<? extends BuildParameter> buildParamClass() default PVarHandler.class;
}
